...
function crearClaseProfesor() {
  ...
  class Profesor {
    ...
    addCertificado(nombre, entidad, anio) {
      ...
      var obj = {"anio": anio, "entidad": entidad, "nombre": nombre};
      return this.certificados.push(obj);
    }
    ...
    getCertificados() {
      ...
      let numCursos = this.certificados.length;
      return numCursos;
    ...
    getUltimoCertificado() {
      ...
      return this.certificados[this.certificados.length-1]; 
    }
